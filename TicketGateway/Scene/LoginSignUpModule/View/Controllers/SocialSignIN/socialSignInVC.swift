...
final class socialSignInVC : UIViewController{
    ...
    func funGoogleSignIn(uiviewController : UIViewController){
        ...
        let config = GIDConfiguration(clientID: "1090307909671-o90bdqh5777lnkgqk9mugturu85d524g.apps.googleusercontent.com")
        ...
        GIDSignIn.sharedInstance.signIn(withPresenting: uiviewController) { signInResult, error in
            ...
            self.strProfile = "\(profilePicUrl!)"
            print(self.strProfile )
        ...
        let obj = DataHoldOnSocialSignUpProcessModel(strEmail: self.strEmail,strNumber: self.strNumber, strStatus: "", strDialCountryCode: "", strCountryCode: "", strName: self.strName,strProfile:"" )
        }
